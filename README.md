...
This project predicts whether a loan applicant is likely to be a Good Credit or Bad Credit customer using the German Credit dataset. The goal is not only to build a predictive model, but also to create a business-focused credit risk intelligence system that supports responsible lending decisions.
